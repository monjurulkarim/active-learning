...
def display_instances_5f_for_annotation(image,file,filename,filesize, boxes, masks, class_ids, class_names,a,c,d,e,Xcor,Ycor,Xcor3,Ycor3,Xcor4,Ycor4,Xcor5,Ycor5,
                      scores=None, title="",
                      figsize=(16, 16), ax=None,
                      show_mask=True, show_bbox=False, #Raju: I changed "show_bbox = False", previously =True
                      colors=None, captions=None):
